...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("reactspringheroku");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("reactspringheroku");
        ...
        config.getMapConfigs().put("fi.ilkka.demo.heroku.domain.*", initializeDomainMapConfig(jHipsterProperties));
